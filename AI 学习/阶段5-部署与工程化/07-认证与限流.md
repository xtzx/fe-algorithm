...
# 使用
limiter = RateLimiter(capacity=10, rate=0.5)  # 10 个容量，每 2 秒恢复 1 个
...
# 不同等级的限流配置
TIER_LIMITS = {
    "free": {"rpm": 10, "tpm": 1000},      # 每分钟 10 请求，1000 token
    "pro": {"rpm": 100, "tpm": 100000},    # 每分钟 100 请求，10 万 token
...
继续 [08-Docker部署.md](./08-Docker部署.md)
