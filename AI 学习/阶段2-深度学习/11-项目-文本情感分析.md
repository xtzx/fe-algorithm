...
print(f"'great' 的索引: {vocab['great']}")
print(f"'<unk>' 的索引: {vocab['<unk>']}")
...
print(f"批次文本形状: {texts.shape}")
print(f"批次标签形状: {labels.shape}")
print(f"序列长度: {lengths[:5]}")
```
...
完成两个项目后，进行 [12-自测清单.md](./12-自测清单.md) 检验学习效果！
