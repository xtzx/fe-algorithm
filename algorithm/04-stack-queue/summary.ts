 ...
 * ┌───────────────────────────────────────────────────────────────────────┐
 * │ Q: 栈和队列有什么区别？                                                │
 * │ A: LIFO vs FIFO，栈用于匹配/回退，队列用于调度/BFS                     │
 * ├───────────────────────────────────────────────────────────────────────┤
 * │ Q: 什么是单调栈？什么时候用？                                          │
 * │ A: 栈内元素保持单调性，找下一个更大/小元素，找大用递减栈               │
 * ├───────────────────────────────────────────────────────────────────────┤
 * │ Q: 柱状图最大矩形怎么解？                                              │
 * │ A: 单调递增栈找左右边界，加哨兵简化边界处理                            │
 * ├───────────────────────────────────────────────────────────────────────┤
 * │ Q: 接雨水有几种解法？                                                  │
 * │ A: DP/双指针/单调栈，双指针空间 O(1) 最优                              │
 * ├───────────────────────────────────────────────────────────────────────┤
 * │ Q: 单调队列和单调栈有什么区别？                                        │
 * │ A: 单调队列双端操作，用于滑动窗口最值，需要移除过期元素                │
 * ├───────────────────────────────────────────────────────────────────────┤
 * │ Q: 两个栈实现队列的时间复杂度？                                        │
 * │ A: 均摊 O(1)，每个元素最多倒腾一次                                     │
 * └───────────────────────────────────────────────────────────────────────┘
 ...
 * ├── easy/
 * │   ├── 001-valid-parentheses.ts
 * │   ├── 002-implement-queue-using-stacks.ts
 * │   ├── 003-implement-stack-using-queues.ts
 * │   ├── 004-min-stack.ts
 * │   └── 005-next-greater-element-i.ts
 * ├── medium/
 * │   ├── 001-daily-temperatures.ts
 * │   ├── 002-evaluate-reverse-polish.ts
 * │   ├── 003-decode-string.ts
 * │   ├── 004-next-greater-element-ii.ts
 * │   ├── 005-simplify-path.ts
 * │   ├── 006-remove-k-digits.ts
 * │   └── 007-validate-stack-sequences.ts
 * └── hard/
 *     ├── 001-largest-rectangle-histogram.ts
 *     ├── 002-sliding-window-maximum.ts
 *     └── 003-trapping-rain-water.ts
 */
